...
int main() {
	...
	//create window
	GLFWwindow* window = glfwCreateWindow(800, 600, "OpenGL_try3", NULL, NULL);
	if (window == NULL) {
	...
	Shader shader_1("D:\\Project_File\\Rain\\OpenGL\\GLSL\\try3_vet.frag", "D:\\Project_File\\Rain\\OpenGL\\GLSL\\try3_frag.frag");
	...
	if (data) {
		...
		std::cout << "Fail to laod texture" << std::endl;
	}
